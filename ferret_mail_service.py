...
Ferret Mail 只负责收件，不提供发信能力。后台默认使用浅色天蓝白主题，支持深色模式、响应式布局和减少动态效果。
...
[data-theme=dark]{color-scheme:dark;--bg:#111112;--panel:#1b1b1d;--panel2:#151517;--panel3:#242426;--text:#e9e9ea;--muted:#a5a5a8;--border:#3a3a3f;--accent:#d7d7d9;--accentText:#121214;--accent2:#b8b8bc;--danger:#f87171;--dangerBg:#351b1d;--dangerBorder:#8f3338;--shadow:none}
...
[data-theme=dark][data-visual=moyu]{--bg:#111112;--panel:rgba(29,29,31,.96);--panel2:rgba(22,22,24,.94);--panel3:#28282b;--text:#eeeeef;--muted:#a8a8aa;--border:#4a4a4f;--accent:#d7d7d9;--accentText:#111112;--accent2:#bdbdc1;--danger:#e8766d;--dangerBg:#351d1c;--dangerBorder:#8f3f39;--shadow:0 18px 42px rgba(0,0,0,.28)}
...
[data-theme=dark]{--bg:#111318;--panel:#191c23;--panel2:#20242d;--panel3:#222b3c;--text:#edf1f7;--muted:#9aa5b5;--border:#333946;--accent:#77a6ff;--accentText:#0d1728;--accent2:#5dd2bd;--danger:#ff8a8a;--dangerBg:#321e22;--dangerBorder:#71383e;--shadow:none}
...
:root[data-theme="dark"][data-visual="skyline"]{
  color-scheme:dark;--bg:#0d1f2d;--panel:rgba(19,43,60,.91);--panel2:#17384f;--panel3:#1c4865;
...
html[data-theme="dark"][data-visual="skyline"] body{background:linear-gradient(145deg,#0b1c29,#102d40 55%,#0c2332)!important}
...
<div class="app">
  ...
  <main class="main">
    <div class="top">
      ...
      <div class="toolbar topActions"><span class="pill livePill" id="liveStatus">连接中</span><button id="copyAddress">复制邮箱</button><button id="refreshMessages" class="secondary">刷新</button><details class="quickMenu"><summary class="secondary">更多</summary><div class="quickMenuPanel"><button id="notifyToggle" class="secondary">邮件通知</button><button class="secondary" id="themeToggle">深色模式</button><a class="secondary" href="/api-docs.md" download>API 文档</a><a class="secondary" href="/usage-guide.md" download>使用帮助</a></div></details></div>
    </div>
...
function setVisual(v,silent=false){document.documentElement.dataset.visual="skyline";storeSet("ferret_mail_visual","skyline")}
setTheme(storeGet("ferret_mail_theme")||"light",true);
setVisual("skyline",true);
...
on("visualToggle","click",()=>setVisual(document.documentElement.dataset.visual==="moyu"?"minimal":"moyu"));
...
<div class="shell">
  <header class="top">
    ...
    <div class="toolbar"><button class="secondary" id="themeBtn">深色</button><button id="refreshBtn">刷新</button><button class="secondary" id="copyCodesBtn">复制本页验证码</button></div>
  </header>
  <section class="card">
